...
class Guardianstar {
    constructor(containerDiv, outputTextarea) {
        ...
        this.starIdArr = ['meiditongliya', 'oulebzhangyixing', 'quechaozhuyilong', 'haierchenxiao', 'oulebyangzi', 'haiermaoxiaotong', 'changhongsongyi', 'skgwangyibo'];
...
class Stall {
        ...
        Promise.all([
            ...
            if (this.data) {
                ...
                utils_1.default.outPutLog(this.outputTextarea, value, true, true);
				 ...
				 utils_1.default.outPutLog(this.outputTextarea, taskData.data.bizMsg, true, true);
    ...
    helpGroup(flag = true) {
        if (new Date().getHours() >= 9) {
            let InviteIdArr = [
                "标记",
				// "XUkkFpUhDG1WJqszpW2uY-4mR3ZvVGMfViX3iMWdE4FeIvO3rYjOC-K6cox9EhbD",
				// "XUkkFpUhDG2BrBniD8B87WcPub-FJ6_7pPjF4qJiL3VUxDtfOdpNSw",
				// "XUkkFpUhDG0XY-p35CzwPZgzlWgMooCLIHRgCJ6uCcuEp4eFyC8",
				// "XUkkFpUhDG2Btg_hMcl899DnswTFg1GOoTL6Vs4fsyQBnHyA4n4u0nl-CwIvNQ",
				// "XUkkFpUhDG1TI6s0r2mrZ0h1OR8jkfp3HylvZcQvb9WvHnYEk_PgMLzmjauS-A",
				// "XUkkFpUhDG0OdMYyr2n7YQfZR3kvq6R89teFSoliKZB165dHj1uQkNOtn65UV57i",
				// "XUkkFpUhDG0ndfh39i2gZVh8RjNne8hgKVDYRvkyq_g"
            ];
