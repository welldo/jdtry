...
class Stall {
    ...
    list() {
        ...
        <button class="deliver" style="width: 120px;height:30px;background-color: #2196F3;border-radius: 5px;border: 0;color:#fff;margin:5px auto;display:block">快递小哥送货任务</button>
        ...
        <button class="steal" style="width: 120px;height:30px;background-color: #2196F3;border-radius: 5px;border: 0;color:#fff;margin:5px auto;display:block">一键抢夺红包</button>
        </div>`;
        ...
        const o = utils_1._$('.signIn'), others = utils_1._$('.others'), group = utils_1._$('.group'), master = utils_1._$('.master'), steal = utils_1._$('.steal'), h = utils_1._$('.help'), a = utils_1._$('.funny'), v = utils_1._$('.viewProduct'), city = utils_1._$('.city'), s = utils_1._$('.shopping'), i = utils_1._$('.invite'), g = utils_1._$('.goodShopping'), timer = utils_1._$('.timer'), deliver = utils_1._$('.deliver'), b = utils_1._$('.raise'), c = utils_1._$(".collect"), browser = utils_1._$('.browser'), assistGroup = utils_1._$('.assistGroup'), helpGroup = utils_1._$('.helpGroup'), assist = utils_1._$('.assist'), p = utils_1._$('.addproduct');
        ...
        c.addEventListener('click', () => {
            utils_1.default.outPutLog(this.outputTextarea, `收取金币`);
            this.collect();
        });
    ...
    single(taskId, itemId) {
        var postData = { "taskId": taskId, "itemId": itemId, "ss": `{\"extraData\":{},\"businessData\":{\"taskId\":${taskId},\"rnd\":\"\",\"inviteId\":\"-1\",\"stealId\":\"-1\"},\"secretp\":\"${this.secretp}\"}`, "shopSign": "" };
    ...
    collect() {
        this.request('stall_collectProduceScore', { "ss": `{\"extraData\":{},\"businessData\":{\"taskId\":\"collectProducedCoin\",\"rnd\":\"729594\",\"inviteId\":\"-1\",\"stealId\":\"-1\"},\"secretp\":\"${this.secretp}\"}` }).then(res => res.json()).then(json => {
            utils_1.default.outPutLog(this.outputTextarea, "领取金币:" + json.data.result.produceScore);
        });
    }
    switchTimer() {
    ...
    visit() {
        return __awaiter(this, void 0, void 0, function* () {
            this.request('stall_myShop', {}).then(res => res.json()).then((json) => __awaiter(this, void 0, void 0, function* () {
                let shopList = json.data.result.shopList;
                let data = shopList.filter((shop) => {
                    return shop['status'] == 1;
                });
                let self = this, length = data.length;
                for (let i = 0; i < length; i++) {
                    let city = data[i], shopSign = city['shopId'];
                    utils_1.default.outPutLog(self.outputTextarea, `任务城市进度：${i + 1}/${length}当前任务城市：${city['name']}`);
                    let postData = { "shopSign": shopSign };
                    yield new Promise(resolve => {
                        this.request('stall_getTaskDetail', postData).then(res => res.json()).then((result) => __awaiter(this, void 0, void 0, function* () {
                                    ...
                                    yield new Promise(resolveFn => {
                                        ...
                                        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                                            yield fetch("https://api.m.jd.com/client.action?functionId=stall_collectScore", {
                                                ...
                                                body: `functionId=stall_collectScore&body=${JSON.stringify({ "taskId": taskVo['taskId'], "itemId": this.getItemIdByName(taskVo, taskVo['taskName'], taskVo['taskId']), "ss": `{\"extraData\":{},\"businessData\":{\"taskId\":${taskVo['taskId']},\"rnd\":\"\",\"inviteId\":\"-1\",\"stealId\":\"-1\"},\"secretp\":\"${this.secretp}\"}`, "shopSign": shopSign })}&client=wh5&clientVersion=1.0.0`
                                            }).then(function (response) {
                                                return response.json();
                                            }).then((res) => {
    ...
    steal() {
        return __awaiter(this, void 0, void 0, function* () {
            this.request('stall_pk_getStealForms', {}).then(json => json.json()).then((res) => __awaiter(this, void 0, void 0, function* () {
                let stealGroups = res.data.result.stealGroups;
                let self = this, length = stealGroups.length;
                for (let i = 0; i < length; i++) {
                    let steal = stealGroups[i];
                    var postData = { "stealId": steal['id'], "ss": `{\"extraData\":{},\"businessData\":{\"taskId\":\"\",\"rnd\":\"\",\"inviteId\":\"-1\",\"stealId\":\"${steal['id']}\"},\"secretp\":\"${this.secretp}\"}` };
                    yield new Promise(resolve => {
                        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                            fetch("https://api.m.jd.com/client.action?functionId=stall_pk_doSteal", {
                                method: "POST",
                                mode: "cors",
                                credentials: "include",
                                headers: {
                                ...
                                body: `functionId=stall_pk_doSteal&body=${JSON.stringify(postData)}&client=wh5&clientVersion=1.0.0`
                            }).then(function (response) {
                                return response.json();
                            }).then((res) => __awaiter(this, void 0, void 0, function* () {
    ...
    helpGroup() {
        ...
        let InviteIdArr = ['XUkkFpUhDG0XY-p35CzwPZgzlWgMooCLIHRgCJ6uCcuEp4eFzg', 'XUkkFpUhDG1WJqszpW2uY-4mR3ZvVGMfViX3iMWdE4FeIvO3rYjOC-K6cox9EhA'];
        this.assistGroup('https://bunearth.m.jd.com/babelDiy/Zeus/4SJUHwGdUQYgg94PFzjZZbGZRjDd/index.html?shareType=cbdDay&inviteId=' + InviteIdArr[utils_1.default.random(0, InviteIdArr.length - 1)]);
    }
    group() {
        fetch('https://api.m.jd.com/client.action', {
            method: "POST",
